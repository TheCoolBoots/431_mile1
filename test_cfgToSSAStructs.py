...
class test_cfg_generator(unittest.TestCase):
    ...
    def test_primes(self):
        ...
        serialized0 = functions[0].serialize()
        serialized1 = functions[1].serialize()
        serialized2 = functions[2].serialize()
        ...
        'br label %l4', 
        'l4:', 
        '%t10 = call i32 @prime(i32 %t4)', 
        'br i1 %t10, label %l5, label %l6', 
        'l5:', '%t5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32 %t4)', 
        'br label %l6', 
        'l6:', 
